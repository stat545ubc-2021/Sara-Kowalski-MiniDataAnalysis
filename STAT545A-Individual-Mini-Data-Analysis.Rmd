...
**I will be using the filtered data, ulmusGenus, obtained from exercise 2 as the full *vancouver_trees* dataset is too large to plot the frequency of tree diameters in all the genus' listed**
```{r}
ggplot(ulmusGenus, aes(diameter, species_name)) +
  geom_boxplot()
```
