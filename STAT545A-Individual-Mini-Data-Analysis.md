...
``` r
## The following code must be commented out in order to knit the rmd file. If necessary, unncomment the following code to install the packages. 
...
the trees for each species within the Ulmus genus
...
frequency of trees in all the genus’ listed**
...
Utilizing boxplots to look at the frequency of tree diameters for each
species within the Ulmus genus.

**I will be using the filtered data, ulmusGenus, obtained from exercise
2 as the full *vancouver_trees* dataset is too large to plot the
frequency of tree diameters in all the genus’ listed**
...
![](STAT545A-Individual-Mini-Data-Analysis_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
