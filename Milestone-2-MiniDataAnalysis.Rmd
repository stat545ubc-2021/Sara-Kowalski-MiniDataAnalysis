...
### 3.2 Summarizing
To explore the *vancouver_trees* dataset more in depth, I will use various data manipulation techniques to help me complete a summarization activity for each research question listed above. 
...
Based on this futher analysis, I can see that the species *AMERICANA* has the most counts (2252) while *CARPINIFOLIA* has the least (17). 
