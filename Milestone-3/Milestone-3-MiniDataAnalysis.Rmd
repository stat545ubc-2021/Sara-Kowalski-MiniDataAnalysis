...
For the csv file writing part of the task, I will take a summary table I wrote in milestone 2 (*season_van_trees_planted*) and use the **write_csv()** and **here::here()** function to write the table as a csv file into my output folder.

```{r}
## use write_csv to write the summary table into a csv file and use the here::here function to
## put it in the output folder 
## specify the data set to be written into a csv - season_van_trees_planted
## name the new csv file - exported_season_van_trees_planted
write_csv(season_van_trees_planted, here::here("output", "export_season_van_trees_planted "))
```